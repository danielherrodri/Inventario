    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-3">
                <form method="post" action="{{route('usuario.store')}}" class="p-6 bg-white border-b border-gray-200 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input value="{{old('apematerno')}}" class="required appearance-none block w-full text-gray-700 
                        ...
                        <div class="flex flex-col">
                            ...
                            <input value="{{old('apepaterno')}}" class="required appearance-none block w-full text-gray-700 
                                border rounded py-3 px-4 leading-tight text-sm
                        ...
                        <div class="flex flex-col">
                            ...
                            <input value="{{old('email')}}" class="required appearance-none block w-full text-gray-700 
                                border rounded py-3 px-4 leading-tight text-sm
                        ...
                        <div class="flex flex-col">
                            ...
                            <select name="rol" class="required block w-full text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none border-gray-800 text-sm" id="rol" placeholder="Ingresa el rol del usuario">
                                ...
                                <option {{old('rol')==$rol->id? 'selected': ''}} value="{{$rol->id}}">{{$rol->nombre}}</option>
                                @endforeach
                                @endif
                            </select>
                            @error('rol')
